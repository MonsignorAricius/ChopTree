...
public class ChopTreeBlockListener implements Listener {
    ...
    private boolean matchLeafType(Block leafBlock, Material firstBlockType) {
        ...
        leafMatch.put(Material.AZALEA_LEAVES, Material.SPRUCE_LOG);
        leafMatch.put(Material.NETHER_WART_BLOCK, Material.CRIMSON_STEM);
        leafMatch.put(Material.WARPED_WART_BLOCK, Material.WARPED_STEM);
    ...
    public boolean denyActive(Player player) {
        ChopTreePlayerListener ctPlayer = new ChopTreePlayerListener(plugin, player.getName());
