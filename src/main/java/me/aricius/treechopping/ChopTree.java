...
public class ChopTree extends JavaPlugin {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        if (!commandLabel.equalsIgnoreCase("ChopTree") && !commandLabel.equalsIgnoreCase("ct")) {
            if (commandLabel.equalsIgnoreCase("ToggleChop") || commandLabel.equalsIgnoreCase("tc")) {
                ChopTreePlayerListener ctPlayer = new ChopTreePlayerListener(this, sender.getName());
    ...
    public void loadConfig() {
        ...
        String[] allowedToolString = this.config.getString("AllowedTools", "WOODEN_AXE,STONE_AXE,IRON_AXE,GOLDEN_AXE,DIAMOND_AXE,NETHERITE_AXE").split(",");
        String[] var2 = allowedToolString;
        int var3 = allowedToolString.length;

        for(int var4 = 0; var4 < var3; ++var4) {
            String tool = var2[var4];
